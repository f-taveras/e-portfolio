...
import { SiTailwindcss, SiNextdotjs, SiDjango, SiApache, SiMeta, SiOpenai, SiN8N } from 'react-icons/si';
...
const skills = {
  ...
  skillList: [
    ...
    { icon: <SiMeta />, name: "Ollama" },
    { icon: <SiOpenai />, name: "ChatGPT" },
  ]
}

const SkillCarousel = ({ showHeader = true }) => {
  const settings = {
    dots: false,
    infinite: true,
    slidesToShow: 4,
